  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("حف بزوس}",style: TextStyle(fontSize: 20,color: Colors.black),),),
...
class Bernard_Arnault extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.blue,
        title: Text(" Bernard Arnault",style: TextStyle(fontSize: 20,color: Colors.black,),),),
        body:Padding(padding: EdgeInsets.all(5),child:  ListView(children: [ Column(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Container(
...
class Larry_Ellison extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.blue,
        title: Text("Larry Elisson",style: TextStyle(fontSize: 20,color: Colors.black,),),),
        body:Padding(padding: EdgeInsets.all(5),child:  ListView(children: [ Column(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            Container(
